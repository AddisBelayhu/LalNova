-- Create partnership_inquiries table for LalNova Technologies
-- Run this SQL in your MySQL database (lalnova_dev)
...
SELECT 'Partnership table created successfully!' AS status;
